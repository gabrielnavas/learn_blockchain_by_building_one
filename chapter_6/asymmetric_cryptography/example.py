...
encrypted = bobs_box.encrypt(b"Hello Alice, how are you?")
...
print(plaintext.decode('utf-8')) # Hello Alice, how are you?

# We encrypt Bob's secret message (bytes)...
encrypted = alices_box.encrypt(b"Oh, Bob, very good!!")

# Now bob can decrypt the message:
encrypted + b'\xd2'
plaintext = bobs_box.decrypt(encrypted)
print(plaintext.decode('utf-8')) # Oh, Bob, very good!!