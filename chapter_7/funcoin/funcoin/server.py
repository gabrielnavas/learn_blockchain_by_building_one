...
import structlog
from marshmallow.exception import MarshmallowError
...
class Server:
    ...
    async def handle_connection(self, reader: StreamReader, writer: StreamWriter):
        ...
        while True:
            try:
                """
                    Wait forever on new data to arrive (WARNING)
                    This is the first of some potential vulnerabilities 
                    that you should be on the lookout for, since anyone could
